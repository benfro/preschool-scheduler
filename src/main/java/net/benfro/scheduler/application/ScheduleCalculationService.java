 ...
 *
 * <p>Only a single {@link net.benfro.scheduler.domain.Group} per request is supported for
 ...
 * plain constructor-injected POJO underneath, so {@link net.benfro.scheduler.adapter.in.cli.ScheduleDemoCli}
