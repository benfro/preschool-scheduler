...
import static net.benfro.scheduler.solver.SchedulingConstants.MAX_TEACHING_SLOTS_PER_TEACHER_PER_DAY;
import static net.benfro.scheduler.solver.SchedulingConstants.MINUTES_PER_HOUR;
import static net.benfro.scheduler.solver.SchedulingConstants.PLANNING_TARGET_WEIGHT;
import static net.benfro.scheduler.solver.SchedulingConstants.SLOT_MINUTES;
import static net.benfro.scheduler.solver.SchedulingConstants.WEEKLY_PLANNING_TIME_TARGET_MINUTES;
