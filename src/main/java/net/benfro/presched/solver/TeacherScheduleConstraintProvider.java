...
import net.benfro.presched.solver.constraint.BreakConstraints;
import net.benfro.presched.solver.constraint.CoverageConstraints;
import net.benfro.presched.solver.constraint.FairnessConstraints;
import net.benfro.presched.solver.constraint.PreferenceConstraints;
import net.benfro.presched.solver.constraint.ShiftShapeConstraints;
import net.benfro.presched.solver.constraint.WorkingHoursConstraints;
 ...
 * {@link net.benfro.presched.solver.constraint}:
 * <ul>
